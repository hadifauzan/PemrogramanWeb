            ...
            <div class="row">
                <div class="col-lg-3">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"
                        data-bs-whatever="@ndo"> <i class="fa fa-plus"></i> Tambah Anggota</button>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td><?= $row['username']; ?></td>
                                <td>
                                    <a href="index.php?page=anggota/edit&id=<?php echo $row['user_id']; ?>"
                                        class="btn btn-warning btn-xs"><i class="fa fa-pencil-square-o"
                                            aria-hidden="true"></i> Edit</a>
                                    <a href="fungsi/hapus.php?anggota=hapus&id=<?php echo $row['user_id']; ?>"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="jabatan" name aria-label="Default select example">
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ?>
                                        <option value="<?= $row2['id']; ?>"><?= $row['jabatan']; ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jenis kelamin" value="L" checked> <label 
                                        class="form-check-label for" = "inlineRadio1">Laki-Laki</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input type=" radio" name="jenis kelamin" value="p"> <label
                            ...
                            <div class="mb-3">
                                <label for="recipient-name" class="col-form-label">No Telepon:</label> <input
                                    type="number" name="no_telp" class="form-control" id="recipient-name">
                            </div>
